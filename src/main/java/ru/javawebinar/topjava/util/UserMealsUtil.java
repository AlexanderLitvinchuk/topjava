...
public class UserMealsUtil {
        ...
        for (UserMeal meal : meals) {
            ...
            if (TimeUtil.isBetweenHalfOpen(localTime, startTime, endTime)) {
                userMealWithExcessList.add(
                        mapperUserMealToUserMealWithExcess(
                                meal,
    ...
    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        return meals.stream()
                ...
                .map(userMeal -> mapperUserMealToUserMealWithExcess(
                        userMeal,
    ...
    /**
     * Создание нового объекта UserMealWithExcess из объекта UserMeal
     *
     * @param userMeal Объект порции
     * @param excess   превышены ли калории в день
     * @return Новый объект UserMealWithExcess
     */
    private static UserMealWithExcess mapperUserMealToUserMealWithExcess(UserMeal userMeal, boolean excess) {
